...
curl http://172.20.10.5:8091/v1/voices/default  # TTS 音色查询
```
...
```bash
# 查询当前 default 预设
curl http://172.20.10.5:8091/v1/voices/default

# 选择预设音色（温柔女声）+ 方言
curl -X POST http://172.20.10.5:8091/v1/voices \
...
curl -X POST http://172.20.10.5:8091/v1/audio/speech \
  -H "Content-Type: application/json" \
